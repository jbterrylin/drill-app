...
class GroupApi {
  ...
  Future<OnlyId?> createGroup(CreateGroupReq input) async {
    final data =
        await httpService.post('$baseUrl/v1/group/create', input.toJson());
  ...
  Future<OnlyId?> createGroupInvite(CreateGroupInviteReq input) async {
    final data = await httpService.post(
        '$baseUrl/v1/group_invite/create', input.toJson());
    return OnlyId.fromJson(data);
  }
  ...
  Future<GetGroupInviteListResp?> getGroupInviteList(
    ...
    final data =
        await httpService.post('$baseUrl/v1/group_invite/list', input.toJson());
  ...
  Future<Base?> updateGroupInviteStatus(
    ...
    final data = await httpService.post(
        '$baseUrl/v1/group_invite/update/status', input.toJson());
  ...
  Future<GetGroupUserListResp?> getGroupUserList(
    ...
    final data =
        await httpService.post('$baseUrl/v1/group_user/list', input.toJson());
